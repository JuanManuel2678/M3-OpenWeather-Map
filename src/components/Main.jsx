...
export const Main = ({ data }) => {
  ...
  return (
    <section className="text-center text-white font-bold flex flex-col flex-wrap justify-between items-center p-8 bg-[#100E1D] h-screen w-[calc(140vh - 459px)] ml-10">
