...
export const Modal = ({
  ...
  const city = ["London", "Barcelona", "Long Beach"];
  ...
  return (
    ...
    <div className="w-[459px] h-screen absolute bg-[#1E213A] text-white font-raleway flex flex-col p-11 gap-6 border-2 border-black">
      ...
      <div className="w-full flex justify-end ">
        <button
          className=" hover:bg-[#E7E7EB] hover:text-[#555555] active:bg-[#B5B5BB] transition duration-300 rounded-full"
      ...
      <header className="flex gap-2 w-[366px] h-[48px] mt-10 ">
        ...
        <div className=" flex gap-2 p-2 w-[268px] h-[48px] border-2 border-[grey]">
          <img
            src='/lupa.svg'
            alt="icon lupa"
            className="w-[24px] h-[24px] top-1/2"
          />
          <input
            type="text"
        ...
        <button
          ...
          className=" w-[86px] h-[48px] bg-[#3C47E9] font-semibold text-base hover:bg-[#E7E7EB] hover:text-[#555555] active:bg-[#B5B5BB] transition duration-300-"
        >
          Search
        </button>
          ...
          city.map((city) => (
            ...
            >
              ...
              <img
                src="/vector.svg"
                alt="vector"
                className="w-5 h-5 relative bg-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
            </li>
          ))}
      </ul>
